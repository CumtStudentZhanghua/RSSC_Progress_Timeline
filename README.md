...
| 2022.04 | **RS** | ACGLNet | [An Attention Cascade Global–Local Network for Remote Sensing Scene Classification](https://www.mdpi.com/2072-4292/14/9/2042) | ResNet50 and DenseNet121 | xxx | Extract {C₂–C₅} from ResNet50+DenseNet121, use C₅ spatial attention to weight lower layers → Fₗ, apply cascaded top-down fusion → Pₗ → average → Nₘ→GAP → Nₘ, dual-model fusion via Count-Sketch+FFT bilinear pooling  | ✅ |
