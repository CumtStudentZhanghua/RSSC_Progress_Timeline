...
| 2022.03 | **TGRS** | SCViT | [SCViT: A Spatial-Channel Feature Preserving Vision Transformer for Remote Sensing Image Scene Classification](https://ieeexplore.ieee.org/document/9729845) | ViT | Use PA module to iteratively aggregate local tokens via reshape-split-connect with MSA+MLP, add cls token and linear embedding, ViT encoder for global modeling, LCA module for channel weighting in classification token | [N/A] | ✅ |
